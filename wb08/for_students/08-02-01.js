...
class Object1 extends GrObject {
  constructor() {
    ...
    let f2 = new Geom.Face3(0, 2, 3);
    f2.color.setStyle("orange");
    geometry.faces.push(f2);
    let f3 = new Geom.Face3(1, 3, 2);
...
class Object2 extends GrObject {
  constructor() {
    ...
    f1.vertexColors[1] = new T.Color("yellow"); 
    f1.vertexColors[2] = new T.Color("blue"); 
    geometry.faces.push(f1);
    let f2 = new Geom.Face3(0, 2, 3);
    f2.vertexColors[0] = new T.Color("green"); 
    f2.vertexColors[1] = new T.Color("brown"); 
    f2.vertexColors[2] = new T.Color("purple"); 
    geometry.faces.push(f2);
    let f3 = new Geom.Face3(1, 3, 2);
    f3.vertexColors[0] = new T.Color("gray"); 
    f3.vertexColors[1] = new T.Color("lightgreen"); 
    f3.vertexColors[2] = new T.Color("lightblue"); 
    geometry.faces.push(f3);
    geometry.computeFaceNormals();
...
class Object3 extends GrObject {
  constructor() {
    ...
    let f1 = new Geom.Face3(0, 1, 2);
    f1.color.setStyle("orange");
    f1.vertexNormals[0] = new T.Vector3(0, 1, 2);
    f1.vertexNormals[1] = new T.Vector3(2, -1, -1);
    f1.vertexNormals[2] = new T.Vector3(0, 1, 2);
    geometry.faces.push(f1);
    let f2 = new Geom.Face3(0, 2, 3);
    f2.color.setStyle("orange");
    f2.vertexNormals[0] = new T.Vector3(0, 1, 2);
    f2.vertexNormals[1] = new T.Vector3(0, 1, 2);
    f2.vertexNormals[2] = new T.Vector3(-2, 1, 1);
    geometry.faces.push(f2);
    let f3 = new Geom.Face3(1, 3, 2);
    f3.vertexNormals[0] = new T.Vector3(2, -1, -1);
    f3.vertexNormals[1] = new T.Vector3(-2, 1, 1);
    f3.color.setStyle("orange");
    geometry.faces.push(f3);
    geometry.computeFaceNormals();
